...
# For newer build system
BUILD_BROKEN_DUP_RULES := true
TARGET_SUPPORTS_64_BIT_APPS := true
TARGET_SUPPORTS_32_BIT_APPS := false
BUILD_BROKEN_ELF_PREBUILT_PRODUCT_COPY_FILES := true
TARGET_RECOVERY_FORCE_64_BIT := true
...
# sepolicy
BOARD_VENDOR_SEPOLICY_DIRS += device/motorola/hiphi/sepolicy/vendor
BOARD_RECOVERY_SEPOLICY_DIRS += device/motorola/hiphi/sepolicy/recovery
